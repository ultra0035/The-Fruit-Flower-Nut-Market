...
-- Enable Row Level Security and allow public read/write for web store & drivers
-- ==============================================================================
...
DROP POLICY IF EXISTS "Products can be modified by anyone" ON public.products;
...
DROP POLICY IF EXISTS "Drivers can be updated by anyone" ON public.drivers;
...
DROP POLICY IF EXISTS "Delivery zones can be modified by anyone" ON public.delivery_zones;
CREATE POLICY "Delivery zones can be modified by anyone" 
  ON public.delivery_zones FOR ALL USING (true) WITH CHECK (true);

-- Orders Policies
DROP POLICY IF EXISTS "Orders can be read by everyone" ON public.orders;
...
DROP POLICY IF EXISTS "Order items can be read by everyone" ON public.order_items;
...
-- Enable Supabase Realtime publication on orders & products
-- ==============================================================================
DO $$
BEGIN
